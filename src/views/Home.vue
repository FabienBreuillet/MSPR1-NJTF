...
<div>
    ...
    <router-link to="/Carte">La carte</router-link> <br>
...
<script>
import Alertes from '../components/Main/Alertes.vue'
import ConcertActuel from '../components/Main/ConcertActuel.vue'
